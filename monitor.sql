...
CREATE TABLE IF NOT EXISTS `offers` (
  ...
  `require_monitor` tinyint(4) DEFAULT NULL,
...
INSERT INTO `offers` (`id`, `name_en`, `price`, `photo`, `created_at`, `updated_at`, `details_en`, `name_ar`, `details_ar`, `directory`, `input`, `output`, `type`, `status`, `reply_on`, `require_monitor`, `monitor_date`) VALUES
(1, '15-3-2016', NULL, 'radars-15-3-2016.pdf', '2022-04-20 11:47:21', '2022-03-01 08:09:53', 'طباقا لمحضر فحص ظاهري  ( مخزن المواصلات)', 'تشوينات  محطات الرادرار', 'عدد/5 محطات (راس العش - البلاح - شرق الفردان - طوسون - الشلوفة)', 'radars', NULL, NULL, 'التعاقد بين هيئة قناة السويس و مجلس الدفاع الوطني', 'done', NULL, NULL, NULL),
(2, 'يوليو - أغسطس (2017)', NULL, '', '2022-04-20 11:48:01', '2022-03-01 06:24:45', NULL, 'تركيبات  محطات الرادار', 'تركيب عدد 3 محطات رادار(البلاج - طوسون - الشلوفة)', 'radars', NULL, NULL, 'تقرير', 'done', NULL, NULL, NULL),
(3, 'فبراير 2020', NULL, '', '2022-04-20 11:49:31', '2022-03-01 08:29:16', NULL, 'تركيبات  محطات الرادار', 'تركيب عدد 3 محطات  ( فنارة - رأس العش - شرق الفردان)', 'radars', NULL, NULL, 'تقرير', 'done', NULL, NULL, NULL),
(4, 'ابريل - مايو - يونيو (2015)', NULL, '', '2022-04-20 11:50:28', '2022-03-01 08:49:09', 'لا توجد ملاحظات', 'المشاكل الفنية للرادار', 'التركيب المحطات (بورفؤاد - القبة - الكاب - الارسال - جنيفة - بورتوفيق-القنطرة) وبداية التشغيل تعمل بكفاءة 100%', 'radars', NULL, NULL, 'تقرير', 'done', NULL, NULL, NULL),
(5, 'أغسطس 2011', NULL, 'radars-أغسطس 2011.pdf', '2022-04-21 08:05:39', '2022-03-01 08:49:44', 'طباقا لمحضر فحص ظاهري عدد/7 محطات (بورفؤاد - القبة - الكاب -القنطرة -الإرسال - جنيفة - بورتوفيق)', 'تشوينات  محطات الرادرار ( مخزن المواصلات)', 'مرفق ب التعاقد بين هيئة قناة السويس و مجلس الدفاع الوطني إتفاق 28/6/2009 إتفاق 15/3/2016 ملحق إتفاق 7/3/2019', 'radars', NULL, NULL, NULL, 'done', NULL, NULL, NULL),
...
(11, '23-11-2020', NULL, '', '2022-04-20 12:01:33', '2022-03-01 11:27:35', NULL, 'أوامر التوريد', 'أمر توريد رقم 26-1016/08 بخصوص قطع غيار هوائي رادار من نوع chl', 'radars', NULL, NULL, 'أمر توريد', 'done', NULL, NULL, NULL),
(12, '05-09-2010', NULL, '', '2022-04-20 12:02:34', '2022-03-07 10:40:07', NULL, 'أوامر التوريد', 'أمر توريد رقم 1528/670-26 بخصوص توفير قطع غيار بخصوص كبائن GEM', 'radars', NULL, NULL, 'أمر توريد', 'done', NULL, NULL, NULL),
...
(14, '05-09-2010', NULL, '', '2022-04-21 08:15:19', '2022-03-07 10:53:06', NULL, 'أوامر التوريد', 'أمر توريد رقم 1529/670-26 بخصوص توفير قطع غيار بخصوص كبائن GEM', 'radars', NULL, NULL, 'أمر توريد', 'done', NULL, NULL, NULL),
...
(25, 'بدون', NULL, '', '2022-04-21 08:13:18', '2022-03-15 08:31:25', 'بعد إجراءات إستلام مشروع الـVTMS الحالي من الهيئة الإقتصادية  للمشروعات بالمخابرات العامة', 'الرؤية المستقبلية', 'من المحتمل تكون تلال ناتج الردم علي ضفتي القناة الناتجة من الحفر و  التوسعة بالقطاع الجنوبي، مما ينتج عنه مناطق عمياء راداريا  ، مثلما مع حدث من حفر قناة السويس الجديدة و الإضطرار للإحتياج  إلي تركيب محطات رادار جديدة.رفع كفاءة التغطية الرادارية للمنطقة الجنوبية للقناة بعد التفريعة الجديدة التي جاري تنفيذها  من ترقيم 122 كم إلي 162 كم', 'vtms', NULL, NULL, 'تقرير', 'done', NULL, NULL, NULL),
...
(39, '2/3/2022', 'صيانة ال ups خاص بجهاز ال ais بالترسانة', 'power-2022-03-28.png', '2022-03-28 12:02:05', '2022-03-28 07:41:26', NULL, 'صيانة وحدات كهربية', NULL, 'power', '', '', '', NULL, '', NULL, NULL),
...
(43, '17-3-2022', NULL, 'tawkitat-2022466-17-3-2022.pdf', '2022-04-21 08:23:34', '2022-03-28 08:03:41', 'المحطات البحرية بقطاع الاسماعيليه(البلاح- الفردان- طوسون- الدفرسوار)', 'زيارة محطات', 'مطلوب متابعة الشاشات المعطلة بعد المرور وما تم بشأنها', 'tawkitat', '2022466', NULL, 'تقرير', 'waiting', NULL, NULL, NULL),
...
(51, '28-2-2022', 'توريد وتركيب', 'power-1993-28-2-2022.png', '2022-03-31 09:44:19', '2022-03-31 08:50:18', NULL, 'أوامر التوريد', '912/1860-55 توريد عدد/18 كارتة ريموت لزوم شبكات UPS', 'power', '1993', NULL, 'أمر توريد', 'progress', '', NULL, NULL),
(52, '6-3-22', 'امر توريد رقم 1890-55-1428', 'power-706-6-3-22.png', '2022-03-31 09:51:56', '2022-03-31 09:51:56', NULL, 'أوامر التوريد', 'امر توري', 'power', '706', NULL, 'أمر توريد', 'transferred', '', NULL, NULL),
...
(61, '4-04-22', NULL, 'security-2022250-4-04-22.pdf', '2022-04-05 11:28:13', '2022-04-05 11:28:13', NULL, 'رد على استفسار التموين', 'رد على استفسارات الشركات فى المناقصة رقم109 -3572/501 جلسة الاربعاء 6/4/2022 لتوريد وتركيب كاميرات مراقبه لمحطات المياه بمدن القناه', 'security', NULL, '2022250', 'إشاره كتابيه', 'done', '', NULL, NULL),
...
(91, '11-04-22', NULL, 'security-2022267-11-04-22.pdf', '2022-04-20 09:50:50', '2022-04-19 11:22:43', NULL, 'تركيب كاميرات', 'الموافقة على توفير 29 كاميراout door ماركه hikvision وعدد 21 كاميرا in doorمن المتوافر بالسوق المحلى', 'security', NULL, '2022267', 'إشاره كتابيه', 'done', '2022572', NULL, NULL),
